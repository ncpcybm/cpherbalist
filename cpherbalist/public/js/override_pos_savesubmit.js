...
frappe.ui.form.Form = class FrappeForm {
	...
	savesubmit(btn, callback, on_error) {
		var me = this;
                ...
                // Apply only to POS Invoice with POS interface loaded
        if (me.doc.doctype === 'POS Invoice' && (typeof cur_pos !== 'undefined' && cur_pos !== null)) {
            const message = __("Permanently Submit {0}?", [me.docname]);
...
// frappe.ready(() => {
//     const originalSaveSubmit = frappe.ui.Form.prototype.savesubmit;

//     frappe.ui.Form.prototype.savesubmit = function (btn, callback, on_error) {
//         const me = this;
...
//         // For all other doctypes, call the original
//         return originalSaveSubmit.call(this, btn, callback, on_error);
//     };
// });
