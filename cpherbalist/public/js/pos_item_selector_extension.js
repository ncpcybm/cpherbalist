        ...
        render_cart_item(item_data, $item_to_update) {
            ...
            function get_description_html() {
                if (item_data.description) {
                    ...
                    item_data.description = frappe.ellipsis(item_data.item_code, 45);
        ...
        _get_item_html = (item, available_in_other_warehouse, reserved_qty, is_product_bundle = 0) => {
            ...
            return `<div class="item-wrapper"
				...
				<div class="item-detail">
                    ...
                    ${frappe.ellipsis(item.item_name, 20)}


						
					</div>
                    <div class="item-name"><span style="">${frappe.ellipsis(item.item_code, 18)}</span></div>
