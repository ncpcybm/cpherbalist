...
class POSInvoice(SalesInvoice):
	...
	def _validate_stock_availablility(self):
		# Call the original stock availability validation
		frappe.log_error("Custom validate_stock_availability called", "POSInvoiceExtensions")

		# Add your custom logic here
		frappe.msgprint("Custom stock validation logic triggered")

		super(POSInvoice,self)._validate_stock_availablility()
